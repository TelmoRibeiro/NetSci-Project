def load_files():
    ...
    if len(console_arguments) == 1:
        ...
        return contacts_file, meetings_file, phonecalls_file
...
def main():
    contacts_file, meetings_file, phonecalls_file = load_files()
    ...
    final_network = merge_networks([contacts_network, meetings_network, phonecalls_network])
